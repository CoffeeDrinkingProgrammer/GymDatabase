...
<canvas class="chart chartjs-render-monitor" id="card-chart1" height="70" style="display: block; width: 204px; height: 70px;" width="204"></canvas>
</div>
</div>
</div>
...
<canvas class="chart chartjs-render-monitor" id="card-chart3" height="70" width="236" style="display: block; width: 236px; height: 70px;"></canvas>
</div>
</div>
</div>
